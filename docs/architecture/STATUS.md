...
- `python3 -m unittest discover -s tests -v`: 237 deterministic tests pass
  locally.
...
- The declared synthetic suite contains 56 strategy, timing, execution, compliance, and lifecycle
