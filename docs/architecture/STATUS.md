...
- `python3 -m unittest discover -s tests -v`: 233 deterministic tests pass
  locally.
...
- The declared synthetic suite contains 53 strategy, timing, execution, compliance, and lifecycle
