...
- `python3 -m unittest discover -s tests -v`: 142 deterministic tests pass
  locally.
...
- The declared synthetic suite contains 39 strategy, execution, compliance, and lifecycle
