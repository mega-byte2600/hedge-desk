  ...
  return `
    <section class="ws-capital" aria-label="Yellow Sheet and capital partnership explanation">
      ...
      <div class="ws-inspiration">
        ...
        <p>Hedge Desk reflects ideas and disciplines that have influenced mbolton's approach to markets and research, including the public work of the <strong>High-Flyer / DeepSeek team</strong>, <strong>Warren Buffett</strong>, <strong>Benjamin Graham</strong>, and <strong>Ray Dalio / Bridgewater Associates</strong>.</p>
        <p class="ws-inspiration-note">These are inspirations only. mbolton has no stated affiliation with, endorsement from, sponsorship by, or personal relationship with these people or organizations, and Hedge Desk does not claim to represent their views, strategies, proprietary systems, or investment results.</p>
      </div>
